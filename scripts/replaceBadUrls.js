...
const replacements = [
  ...
  ['https://www.gifdotreino.com/Exercicios/Ombros/Eleva%C3%A7%C3%A3o%20lateral%20na%20m%C3%A1quina.gif', 'https://api.smartworkout.app/asset/video/30f3160a-3a57-426a-a3b9-4eed573310f8.mp4']
];

for (const [bad, good] of replacements) {
    dbRaw = dbRaw.split(bad).join(good);
}
...
for (const [bad, good] of replacements) {
    libRaw = libRaw.split(bad).join(good);
}
