          ...
          <AnimatePresence mode="wait">
            ...
            {setupStep === 2 && (
              <motion.div key="2" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="absolute inset-0">
                <h2 className="text-xl font-black font-display text-white">Sincronizando notificações & widgets...</h2>
        ...
        <AnimatePresence mode="wait">
          ...
          {step === 0 && (
            <motion.div key="step0" initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -50 }} className="w-full">
              <h1 className="text-2xl font-display font-black text-white mb-2 leading-tight">O que você quer desenvolver primeiro?</h1>
          ...
          {step === 2 && (
            <motion.div key="step2" initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -50 }} className="w-full">
              <h1 className="text-2xl font-display font-black text-white mb-6 leading-tight">Mapeamento de Rotina</h1>
                  ...
                  <div className="grid grid-cols-2 gap-2.5">
                    {['Menos de 5h', '5-6h', '7-8h', '9h+'].map(opt => (
                      <button key={opt} onClick={() => setAnswers(p => ({ ...p, sleep: opt }))}
                        className={`p-3.5 rounded-xl font-bold text-xs border transition-all ${answers.sleep === opt ? 'bg-neon-blue/20 border-neon-blue text-white shadow-[0_0_12px_rgba(0,240,255,0.2)]' : 'bg-surface/50 border-surface-light text-text-secondary'}`}>{opt}</button>
                    ))}
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-2 gap-2.5">
                    {['Nunca', '1-2x semana', '3-4x semana', '5x+'].map(opt => (
                      <button key={opt} onClick={() => setAnswers(p => ({ ...p, exercise: opt }))}
                        className={`p-3.5 rounded-xl font-bold text-xs border transition-all ${answers.exercise === opt ? 'bg-neon-blue/20 border-neon-blue text-white shadow-[0_0_12px_rgba(0,240,255,0.2)]' : 'bg-surface/50 border-surface-light text-text-secondary'}`}>{opt}</button>
                    ))}
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-2 gap-2.5">
                     {['15 min', '30 min', '1h', '2h+'].map(opt => (
                      <button key={opt} onClick={() => setAnswers(p => ({ ...p, freetime: opt }))}
                        className={`p-3.5 rounded-xl font-bold text-xs border transition-all ${answers.freetime === opt ? 'bg-neon-blue/20 border-neon-blue text-white shadow-[0_0_12px_rgba(0,240,255,0.2)]' : 'bg-surface/50 border-surface-light text-text-secondary'}`}>{opt}</button>
                    ))}
                  </div>
                </div>
              </div>
          ...
          {step === 3 && (
            <motion.div key="step3" initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -50 }} className="w-full">
              <h1 className="text-2xl font-display font-black text-white mb-2 leading-tight">O que mais atrapalha você hoje?</h1>
          ...
          {step === 4 && (
            <motion.div key="step4" initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -50 }} className="w-full">
              <h1 className="text-2xl font-display font-black text-white mb-2 leading-tight">Tom de Voz da Inteligência Artificial</h1>
              ...
              <div className="flex flex-col gap-2.5">
                {[
                  ...
                  >
                    <h3 className={`font-bold text-xs mb-0.5 ${answers.aiTone === opt.id ? 'text-neon-purple' : 'text-white'}`}>{opt.id}</h3>
          ...
          {step === 5 && (
            <motion.div key="step5" initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -50 }} className="w-full">
              <h1 className="text-2xl font-display font-black text-white mb-2 leading-tight">Onde você quer estar daqui 90 dias?</h1>
              ...
              <textarea
                ...
                className="w-full h-40 bg-surface/50 border border-surface-light rounded-2xl p-4 text-xs text-white placeholder:text-text-secondary/50 focus:outline-none focus:border-neon-blue resize-none shadow-inner"
              />
            </motion.div>
          )}
          ...
          {step === 6 && (
            <motion.div key="step6" initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -50 }} className="w-full">
              ...
              <h1 className="text-2xl font-display font-black text-white mb-2 leading-tight">Ative Notificações Inteligentes</h1>
              ...
              <div className="bg-surface/50 border border-surface-light rounded-2xl p-5 mb-6 space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="text-xs font-bold text-white">Lembretes Personalizados</h4>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="text-xs font-bold text-white">Modo Foco Integrado</h4>
              ...
              <button
                ...
                className={`w-full py-4 rounded-xl font-bold text-xs uppercase tracking-wider flex items-center justify-center gap-2 transition-all ${
                  notifGranted 
                    ...
                    : 'bg-neon-blue text-black shadow-[0_0_20px_rgba(0,240,255,0.3)] hover:bg-white'
                }`}
              >
                {notifGranted ? (
                  <>
          ...
          {step === 7 && (
            <motion.div key="step7" initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -50 }} className="w-full">
              ...
              <h1 className="text-2xl font-display font-black text-white mb-2 leading-tight">Adicione à Tela Inicial & Widgets</h1>
              <p className="text-xs text-text-secondary mb-6 leading-relaxed">
              ...
              <div className="space-y-3 mb-6">
                <div className="bg-surface/50 border border-surface-light rounded-2xl p-4 flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="text-xs font-bold text-white mb-1">Passo 1: Menu do Navegador</h4>
                ...
                <div className="bg-surface/50 border border-surface-light rounded-2xl p-4 flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="text-xs font-bold text-white mb-1">Passo 2: Atalho na Tela Inicial</h4>
                    <p className="text-[11px] text-text-secondary leading-normal">
          ...
          {step === 8 && (
            <motion.div key="step8" initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -50 }} className="w-full">
              <h1 className="text-2xl font-display font-black text-white mb-1 leading-tight">Escolha seu Plano de Evolução</h1>
                    ...
                    <div
                      ...
                      className={`relative p-4 rounded-2xl border cursor-pointer transition-all ${p.bg} ${
                        isSelected 
                          ...
                          : 'border-surface-light opacity-80 hover:opacity-100 hover:border-white/30'
                      }`}
                    >
                      {p.popular && (
                        <span className="absolute top-3 right-3 bg-neon-purple text-white text-[9px] font-black uppercase tracking-wider px-2.5 py-0.5 rounded-full">
                          Mais Escolhido
                        </span>
                      )}
                      ...
                      <ul className="grid grid-cols-1 sm:grid-cols-2 gap-1.5 pt-2 border-t border-white/5">
